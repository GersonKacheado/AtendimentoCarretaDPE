...
*/
    ...
    function setAtendenteAtendimento(){
        ...
        $sql = "SELECT * FROM `tbl_user` u, tbl_historico h where u.habilitado = 'S' and (u.fk_tipo_user = 3 or u.fk_tipo_user = 5 or u.fk_tipo_user = 9) and h.fk_iduser = u.iduser and h.fk_idevento = '".$id_evento."'  ORDER BY `u`.`nome_user` ASC";
        ...
        echo "  
                <div class'col-md-6 dropdown'>
                    ...
                    <select class='form-control' name='selecao_user' id='selecao_user' style='width:400px; height:800px;' multiple onchange='getComboA(this)'>";
                        ...
                        @$usuario = '';
                        while($resultado = $this->stmt->fetch(PDO::FETCH_OBJ)) {
                            if($resultado->fk_funcao == 7 && $resultado->fk_tipo_user == 3){ 
                                $cor = 'text-primary';
                            }
                            elseif($resultado->fk_funcao == 7 && $resultado->fk_tipo_user == 5){
                                $cor = 'text-danger';
                            }
                            elseif($resultado->fk_funcao == 8 && $resultado->fk_tipo_user == 9){
                                $cor = 'text-dark';
                            }
