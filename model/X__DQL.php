            ...
            echo "
                <tr style='color:".$cor."'>
                    ...
                    <td class='text-center toggle'>
                        ...
                        <label for='foo'>
                            <a href='model/controller/procedimentos.php?id_evento=".$resultado->id_evento."&valor=".$rotulo."&TARCISO=MarcaVolante' id='rotulo'>".$rotulo."</a>
                        </label>
                    </td><td colspan='1'></td>
                    <td>
                       <a class='btn btn-primary' style='color: ".$cor."' 
