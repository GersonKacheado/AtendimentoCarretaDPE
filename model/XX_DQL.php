...
function setListaViewAssistidoAtendimentos($idfila){
    ...
    echo"   <tr>   
                <th>".$contador."</th> 
                    ...
                    <td class='text-center'><a href='?op=recepcao&idfila=".$resultado->idfila."&resp=Tarcisoedit&nome=".$resultado->nome."&fk_atendente=".$resultado->iduser."&fk_tipo_documento=".@$resultado->fk_tipo_documento."&nucleo=".$resultado->dsc_nucleo."&dsc_acao=".$resultado->dsc_acao."&dsc_atendentes=".$resultado->nome_user."&mudarservico=mudarservico'><i style='font-size:24px' class='fa fa-edit text-green 3x'></i></a></td> 
                </td>                
            </tr>";  
    }
}   
