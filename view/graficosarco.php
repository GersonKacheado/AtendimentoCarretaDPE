...
<!-- Barra Sexo -->
  ...
  <body class="container">
    <header style='position:fixed; top:65px;left:250px; width:85%;'>
      <?php  include_once('opcoes.php'); ?>
    </header>
    <section>    
      <div class="mb-5" style="margin-top:250px; width: 100%;">
        <table class="table table-striped">
          <thead>
            <tr>
              <th scope="col">#</th>
              <th class='h4' scope="col" colspan='8'>RESPOSÁVEL PELO ANTIMENTO E SEUS REPSCTIVOS ASSISTIDOS  - <?php $idevento = $_GET['idevento'];  
                $selecionar_dados->setFuncaoEventoRelatorioSelecionado($idevento); ?> 
              </th>
            </tr>
          </thead>
          <tbody>
