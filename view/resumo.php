...
<div class="panel panel-success" id='profissionais'>
    ...
    <div class="panel-body"><h1 class="panel panel-success" style="color:green;">Assistidos Atendidos e Finalizados</h1>
        ...
        <?php
            ...
            $html = "
                <table class='col-md-12 table table-striped table-responsive'>
                    ...
                    <tbody>";
                        $selecionar_dados->setListaAtendimentoFinalizadosGeral($contador, $valores, $titulo, $html);
                        $html .= "    
                        <tfoot>
