<div class="d-flex flex-column flex-md-row text-center text-md-start justify-content-between py-4 px-4 px-xl-5 bg-success mt-3 text-sm" >
    <!-- Copyright -->
    <div class="text-white mb-3 mb-md-0">
    Copyright &copy Atendimento DPE - 2021 - *
    </div>
    <div>
      <a href="#!" class="text-white me-4 text-sm">Versão 1.0
      </a>
    </div>
  </div>
</section>
...
<?php
$variavel = base64_decode(@$_REQUEST['msg']);
?>
<script>
